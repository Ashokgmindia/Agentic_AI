...
class HostAgent:
    """The Host agent for multi-agent orchestration."""
    ...
    def root_instruction(self, context: ReadonlyContext) -> str:
        ...
        * Integrate responses into clear outputs.
    ...
    async def send_message(self, agent_name: str, task: str, tool_context: ToolContext):
        ...
        # Generate IDs (A2A server will create task automatically)
...
def _get_initialized_host_agent_sync():
    async def _async_main():
        remote_agent_urls = ["http://localhost:10004"]
